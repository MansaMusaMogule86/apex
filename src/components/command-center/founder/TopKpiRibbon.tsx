...
import type { FounderKpi } from "@/components/command-center/founder/types";
  ...
  if (!data.length) {
    return (
      <section className="rounded-xs border border-dashed border-white/20 bg-white/2 p-6 text-center">
        <p className="font-display text-2xl font-light text-warm-white">No founder authority telemetry</p>
        <p className="mt-1 text-sm text-titanium">Attach your intelligence streams to initialize KPI optics.</p>
      </section>
    );
  }
