...
import { AI_RECOMMENDATIONS } from "@/components/command-center/influence/data";
...
export default function AiRecommendationFeed() {
  return (
    <InfluencePanel
      ...
      decisionTie="Execute highest-confidence recommendations to increase trust transfer and influence yield."
    >
