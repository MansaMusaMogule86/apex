...
import type { ReportKpi } from "@/components/command-center/reports/types";
  ...
  if (!data.length) {
    return (
      <section className="rounded-xs border border-dashed border-white/20 bg-white/2 p-6 text-center">
        <p className="font-display text-2xl font-light text-warm-white">No executive report telemetry</p>
        <p className="mt-1 text-sm text-titanium">Connect intelligence streams to initialize KPI reporting.</p>
      </section>
    );
  }
